...
const ACT1_SCENES = {
  ...
  scene_rynek_dialogue_3: {
    ...
    dialogue: [
      {
        speaker: CHARACTERS.MACIEJ,
        text: "Wow, to super! Gratuluję, Kinga!",
      },
    ],
  ...
  scene_rynek_kinga_proposal: {
    ...
    character: {
      left: CHARACTER_SPRITES.MACIEJ,
      right: CHARACTER_SPRITES.KINGA_BLUSH,
    },
    dialogue: [
      {
        speaker: CHARACTERS.KINGA,
  ...
  choice_rynek_kinga_1: {
    ...
    choices: [
      ...
      {
        text: '"Kinga, to dla mnie za duże zobowiązanie. Sorry..."',
        effects: {
  ...
  choice_1_honest: {
    ...
    character: {
      left: CHARACTER_SPRITES.MACIEJ,
      right: CHARACTER_SPRITES.KINGA_NEUTRAL,
    },
    dialogue: [
      {
        speaker: CHARACTERS.KINGA,
  ...
  choice_1_distant: {
    ...
    character: {
      left: CHARACTER_SPRITES.MACIEJ,
      right: CHARACTER_SPRITES.KINGA_SAD,
    },
    dialogue: [
      {
        speaker: CHARACTERS.KINGA,
  ...
  scene_zosia_appears: {
    ...
    character: {
      left: CHARACTER_SPRITES.MACIEJ,
      right: CHARACTER_SPRITES.ZOSIA_NEUTRAL,
    },
    dialogue: [
      {
